const About = () => {
  const applications = [
    {
      applicant: {
        ...
        imageUrl: "/images/earistlogo.png",
      },
      date: "2020-01-07",
      dateFull: "2018 - 2022",
      href: "#",
  ...
  return (
    <div
      className="bg-gray-800 shadow mx-auto max-w-8xl py-12 px-6 lg:py-16 lg:px-14"
      id="mastery"
    >
              ...
              <div className="flex items-center px-4 py-10 sm:px-6">
                <div className="flex min-w-0 flex-1 items-center">
                  <div className="flex-shrink-0">
                    <img
                      className="md:h-32 md:w-32 w-24 h-24 rounded-full"
                  ...
                  <div className="min-w-0 flex-1 px-4 md:grid md:grid-cols-2 md:gap-4">
                    <div className="w-full">
                      <p className="md:text-3xl text-xl font-medium text-white truncate">
